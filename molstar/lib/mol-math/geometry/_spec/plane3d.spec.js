...
describe('plane3d', function () {
    ...
    it('fromCoplanarPoints', function () {
        var a = Vec3.create(2.0, 0.5, 0.25);
        var b = Vec3.create(2.0, -0.5, 1.25);
        var c = Vec3.create(2.0, -3.5, 2.2);
        var p = Plane3D();
    ...
    it('distanceToPoint', function () {
        var p = Plane3D.create(Vec3.create(2, 0, 0), -2);
