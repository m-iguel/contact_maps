...
export declare namespace Shape {
    ...
    function createRenderObject<G extends Geometry>(shape: Shape<G>, props: PD.Values<Geometry.Params<G>>): import("../../mol-gl/render-object").GraphicsRenderObject<"lines" | "text" | "image" | "points" | "spheres" | "cylinders" | "mesh" | "direct-volume" | "texture-mesh">;
    interface Loci {
