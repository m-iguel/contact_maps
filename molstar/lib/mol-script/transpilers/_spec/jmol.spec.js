...
describe('jmol keywords', function () { return u.testKeywords(keywords, transpiler); });
describe('jmol properties', function () { return u.testProperties(properties, transpiler); });
describe('jmol operators', function () { return u.testOperators(operators, transpiler); });
