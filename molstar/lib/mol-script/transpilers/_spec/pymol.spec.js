...
// 'b = 1',
// 'fc.=.1',
describe('pymol keywords', function () { return u.testKeywords(keywords, transpiler); });
describe('pymol operators', function () { return u.testOperators(operators, transpiler); });
describe('pymol properties', function () { return u.testProperties(properties, transpiler); });
