...
var HeadlessScreenshotHelper = /** @class */ (function () {
    function HeadlessScreenshotHelper(externalModules, canvasSize, canvas3d, options) {
        ...
        if (canvas3d) {
            ...
            var webgl_1 = (0, context_1.createContext)(glContext);
            var input_1 = input_observer_1.InputObserver.create();
            var attribs = tslib_1.__assign({}, canvas3d_1.Canvas3DContext.DefaultAttribs);
            var assetManager = new assets_1.AssetManager();
            var passes = new passes_1.Passes(webgl_1, assetManager, attribs);
            var dispose = function () {
                input_1.dispose();
                webgl_1.destroy();
            };
            this.canvas3d = canvas3d_1.Canvas3D.create({ webgl: webgl_1, input: input_1, passes: passes, attribs: attribs, assetManager: assetManager, dispose: dispose }, (_b = options === null || options === void 0 ? void 0 : options.canvas) !== null && _b !== void 0 ? _b : defaultCanvas3DParams());
        }
...
function defaultCanvas3DParams() {
    return {
        ...
        postprocessing: tslib_1.__assign(tslib_1.__assign({}, canvas3d_1.DefaultCanvas3DParams.postprocessing), { occlusion: {
                name: 'off', params: {}
            }, outline: {
                name: 'off', params: {}
            }, antialiasing: {
            ...
            }, background: { variant: { name: 'off', params: {} } }, shadow: { name: 'off', params: {} } })
    };
}
...
function defaultImagePassParams() {
    return {
        ...
        multiSample: tslib_1.__assign(tslib_1.__assign({}, canvas3d_1.DefaultCanvas3DParams.multiSample), { mode: 'on', sampleLevel: 4 })
    };
}
