...
var sb_ncbr_1 = require("../../extensions/sb-ncbr");
var struct_conn_1 = require("../../extensions/wwpdb/struct-conn");
var behavior_4 = require("../../extensions/wwpdb/ccd/behavior");
var behavior_5 = require("../../extensions/rcsb/assembly-symmetry/behavior");
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        spec = {
                            ...
                            behaviors: tslib_1.__spreadArray(tslib_1.__spreadArray([], defaultSpec.behaviors, true), o.extensions.filter(function (e) { return !disabledExtension.has(e); }).map(function (e) { return exports.ExtensionMap[e]; }), true),
                            ...
                            components: tslib_1.__assign(tslib_1.__assign({}, defaultSpec.components), { controls: tslib_1.__assign(tslib_1.__assign({}, (_b = defaultSpec.components) === null || _b === void 0 ? void 0 : _b.controls), { top: o.layoutShowSequence ? undefined : 'none', bottom: o.layoutShowLog ? undefined : 'none', left: o.layoutShowLeftPanel ? undefined : 'none' }), remoteState: o.layoutShowRemoteState ? 'default' : 'none' }),
                            config: [
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        if (!!!structure.models.some(function (m) { return sb_ncbr_1.SbNcbrPartialChargesPropertyProvider.isApplicable(m); })) return [3 /*break*/, 6];
