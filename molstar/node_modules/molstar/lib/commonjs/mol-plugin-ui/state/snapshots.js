...
var LocalStateSnapshots = /** @class */ (function (_super) {
    ...
    LocalStateSnapshots.prototype.render = function () {
        return (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(parameters_1.ParameterControls, { params: LocalStateSnapshots.Params, values: this.state.params, onEnter: this.add, onChangeValues: this.updateParams }), (0, jsx_runtime_1.jsxs)("div", { className: 'msp-flex-row', children: [(0, jsx_runtime_1.jsx)(common_1.IconButton, { onClick: this.clear, svg: icons_1.DeleteOutlinedSvg, title: 'Remove All' }), (0, jsx_runtime_1.jsx)(common_1.Button, { onClick: this.add, icon: icons_1.AddSvg, style: { textAlign: 'right' }, commit: true, children: "Add" })] })] });
    };
