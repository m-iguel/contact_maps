...
(function (TrackballControls) {
    function create(input, camera, scene, props) {
        ...
        function onKeyDown(_a) {
            var modifiers = _a.modifiers, code = _a.code, key = _a.key, x = _a.x, y = _a.y;
            if (outsideViewport(x, y))
                return;
        ...
        function onKeyUp(_a) {
            ...
            for (var _i = 0, codes_1 = codes; _i < codes_1.length; _i++) {
                ...
                if (binding_1.Binding.matchKey(b.keyMoveForward, code_1, modifiers, key)) {
                    keyState.moveForward = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyMoveBack, code_1, modifiers, key)) {
                    keyState.moveBack = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyMoveLeft, code_1, modifiers, key)) {
                    keyState.moveLeft = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyMoveRight, code_1, modifiers, key)) {
                    keyState.moveRight = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyMoveUp, code_1, modifiers, key)) {
                    keyState.moveUp = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyMoveDown, code_1, modifiers, key)) {
                    keyState.moveDown = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyRollLeft, code_1, modifiers, key)) {
                    keyState.rollLeft = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyRollRight, code_1, modifiers, key)) {
                    keyState.rollRight = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyPitchUp, code_1, modifiers, key)) {
                    keyState.pitchUp = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyPitchDown, code_1, modifiers, key)) {
                    keyState.pitchDown = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyYawLeft, code_1, modifiers, key)) {
                    keyState.yawLeft = 0;
                }
                else if (binding_1.Binding.matchKey(b.keyYawRight, code_1, modifiers, key)) {
                    keyState.yawRight = 0;
                }
            }
            if (binding_1.Binding.matchKey(b.boostMove, code, modifiers, key)) {
