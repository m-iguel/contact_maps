    ...
    params: function (a) {
        if (!a) {
            return {
                ...
                blockHeader: PD.Optional(PD.Text(void 0, { description: 'Header of the block to parse. If not specifed, Block Index parameter applies.', hideIf: function (p) { return p.loadAllBlocks === true; } })),
                blockIndex: PD.Optional(PD.Numeric(0, { min: 0, step: 1 }, { description: 'Zero-based index of the block to parse. Only applies when Block Header parameter is not specified.', hideIf: function (p) { return p.loadAllBlocks === true || p.blockHeader; } })),
            };
        }
        ...
        return {
            ...
            blockHeader: PD.Optional(PD.Select(blocks[0] && blocks[0].header, headers, { description: 'Header of the block to parse. If not specifed, Block Index parameter applies.', hideIf: function (p) { return p.loadAllBlocks === true; } })),
            blockIndex: PD.Optional(PD.Numeric(0, { min: 0, step: 1, max: blocks.length - 1 }, { description: 'Zero-based index of the block to parse. Only applies when Block Header parameter is not specified.', hideIf: function (p) { return p.loadAllBlocks === true || p.blockHeader; } })),
        };
    }
})({
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 11:
                        _d = _f.sent();
                        return [3 /*break*/, 14];
                    case 12: return [4 /*yield*/, trajectoryFromMmCIF(block, a.data).runInContext(ctx)];
                    case 13:
                        _d = _f.sent();
                        _f.label = 14;
                    case 14:
