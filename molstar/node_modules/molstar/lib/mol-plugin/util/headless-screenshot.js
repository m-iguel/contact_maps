...
var HeadlessScreenshotHelper = /** @class */ (function () {
    function HeadlessScreenshotHelper(externalModules, canvasSize, canvas3d, options) {
        ...
        if (canvas3d) {
            ...
            var webgl_1 = createContext(glContext);
            var input_1 = InputObserver.create();
            var attribs = __assign({}, Canvas3DContext.DefaultAttribs);
            var assetManager = new AssetManager();
            var passes = new Passes(webgl_1, assetManager, attribs);
            var dispose = function () {
                input_1.dispose();
                webgl_1.destroy();
            };
            this.canvas3d = Canvas3D.create({ webgl: webgl_1, input: input_1, passes: passes, attribs: attribs, assetManager: assetManager, dispose: dispose }, (_b = options === null || options === void 0 ? void 0 : options.canvas) !== null && _b !== void 0 ? _b : defaultCanvas3DParams());
        }
...
export function defaultCanvas3DParams() {
    return {
        ...
        postprocessing: __assign(__assign({}, DefaultCanvas3DParams.postprocessing), { occlusion: {
                name: 'off', params: {}
            }, outline: {
                name: 'off', params: {}
            }, antialiasing: {
...
export function defaultImagePassParams() {
    return {
        ...
        multiSample: __assign(__assign({}, DefaultCanvas3DParams.multiSample), { mode: 'on', sampleLevel: 4 })
    };
}
